...
public class Temporal implements java.io.Serializable {
    ...
    public Temporal(long id, String tramNum, Date fecha, String origen, String asunto, BigDecimal impreso, BigDecimal reimpreso, String destino, String siglas, String tiposdocumentos, String contador) {
        this.id = id;
